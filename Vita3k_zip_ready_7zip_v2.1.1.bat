...
echo [STEP 3] ZIP compression with 7-Zip
echo [FILE] !RAWZIP!
...
if exist "addcont" (
    "%SEVENZIP%" a -tzip "..\!RAWZIP!" "app" "addcont" >nul 2>&1
) else (
    "%SEVENZIP%" a -tzip "..\!RAWZIP!" "app" >nul 2>&1
)
set "WERR=!errorlevel!"
popd >nul 2>nul

echo [DEBUG] 7-Zip exit code for !TITLEID!: !WERR!
...
if not "!WERR!"=="0" if not "!WERR!"=="1" (
    >>"%ERRORLOG%" echo !TITLEID! - 7ZIP ERROR !WERR!
    set "ZIPRES=ZIP_FAIL"
    goto Cleanup
)
