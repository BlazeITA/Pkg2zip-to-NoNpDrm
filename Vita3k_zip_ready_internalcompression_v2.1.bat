...
pushd "!TMPDIR!"
if exist "addcont" (
    powershell -NoProfile -Command "Compress-Archive -Path 'app','addcont' -DestinationPath '..\!RAWZIP!' -Force"
) else (
    powershell -NoProfile -Command "Compress-Archive -Path 'app' -DestinationPath '..\!RAWZIP!' -Force"
)
popd
